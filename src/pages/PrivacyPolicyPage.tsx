        ...
        <section className="relative overflow-hidden bg-on-background pb-16 pt-28 text-white sm:pb-20 sm:pt-32 lg:pb-24 lg:pt-40">
          <div className="relative z-10 mx-auto max-w-screen-2xl px-4 sm:px-6 md:px-8 xl:px-10">
            <m.div
              ...
              className="max-w-4xl"
            >
              <span className="label-md mb-6 block uppercase tracking-[0.4em] text-primary sm:mb-8">Legal_Protocol</span>
              <h1 className="mb-8 text-4xl font-extrabold uppercase italic leading-[0.9] tracking-tight sm:text-5xl md:mb-10 md:text-7xl xl:text-8xl">
                Privacy <br /><span className="text-white/40 italic font-medium opacity-80">Policy</span>
              </h1>
            ...
            <div className="space-y-8">
              ...
              <div className="mt-2 rounded-xl bg-surface-container-low px-5 py-5 sm:px-6">
                ...
                <p className="text-sm leading-7 text-on-surface-variant">
                  This policy should be reviewed by qualified Saudi legal counsel before final publication to confirm alignment with your exact hosting setup, processors, retention periods, cookies, and corporate registration details.
                </p>
              </div>
            </div>
          </div>
